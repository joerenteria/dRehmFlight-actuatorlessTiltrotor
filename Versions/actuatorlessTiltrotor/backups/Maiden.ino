...
//Vertical Flight PID
float Kp_roll_angleV = 0.2;    //Roll P-gain - angle mode 
float Ki_roll_angleV = 0.3;    //Roll I-gain - angle mode
float Kp_pitch_angleV = 0.2;   //Pitch P-gain - angle mode
...
void controlANGLE() {
  ...
  integral_roll = constrain(integral_roll, -i_limit, i_limit); //saturate integrator to prevent unsafe buildup
  derivative_roll = GyroX;
  roll_PID = 0.01*(Kp_roll_angleV*error_roll + Ki_roll_angleV*integral_roll - Kd_roll_angle*derivative_roll); //scaled by .01 to bring within -1 to 1 range
  ...
  integral_pitch = constrain(integral_pitch, -i_limit, i_limit); //saturate integrator to prevent unsafe buildup
  derivative_pitch = GyroY;
  pitch_PID = .01*(Kp_pitch_angleV*error_pitch + Ki_pitch_angleV*integral_pitch - Kd_pitch_angle*derivative_pitch); //scaled by .01 to bring within -1 to 1 range
